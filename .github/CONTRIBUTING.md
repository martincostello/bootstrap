...
1. When you think your changes are complete, test that the code builds cleanly using `test.ps1`. There should be no warnings.
...
[contributors]: https://github.com/martincostello/dotnet-bumper/graphs/contributors
